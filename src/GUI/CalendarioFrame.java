...
public class CalendarioFrame {
	...
	private JButton btnVolver, btnBuscarOfertas;
	private JTable tblOferta;
	private JScrollPane spTablero;
	private JLabel lblMejoresOfertasFecha;
	...
	private void initialize() {
		...
		CalendarioFrame.setIconImage(Toolkit.getDefaultToolkit().getImage(
		...
		lblMejoresOfertasFecha = new JLabel("Las ofertas del dia: ");
		...
		btnBuscarOfertas = new JButton("Buscar Ofertas");
		...
		btnBuscarOfertas.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String fechaAComprobar = localDate.getDayOfMonth() + "-" + localDate.getMonth() + "-"
						+ localDate.getYear();
	...
	private void mostrarOfertas(ArrayList<Oferta> ofertas) {
