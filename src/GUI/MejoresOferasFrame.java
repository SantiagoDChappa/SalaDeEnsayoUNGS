...
public class MejoresOferasFrame {
	...
	private JLabel lblResultado, lblMaximaGanancia, lblCantidadDeOfertas, lblMejoresOfertasFecha, lblAlgoritmoUtilizado, lblTiempoDeEjecucion;
    	...
    	MejoresOfertasFrame.getContentPane().add(lblMejoresOfertasFecha);
         ...
         btnAlgoritmoGoloso.addActionListener(new ActionListener() {
             public void actionPerformed(ActionEvent e) {
            	 ...
            	 lblMejoresOfertasFecha.setText("Las mejores ofertas del dia: " + mostrarFecha(calendario.getDate()));
